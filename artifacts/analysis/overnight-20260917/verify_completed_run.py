"""Offline audit of the September 16 source / September 17 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260917T040722.433471Z")
parser.add_argument("--expected-source-date", default="2026-09-16")
parser.add_argument("--expected-action-date", default="2026-09-17")
parser.add_argument("--expected-deadline", default="2026-09-17T11:00:00Z")
