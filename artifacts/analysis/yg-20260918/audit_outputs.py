...
NATIVE = ROOT / 'ml/overnight-runs/20260918T072554.369355Z'
YG = ROOT / 'ml/nightly-gameplan-runs/20260918T072555.813034Z'
...
def main():
    ...
    lines = [
        ...
        f"Frozen model statuses are {json.dumps(summary['model_status_counts'], sort_keys=True)}. Model fitting/inference is covered by the separate model review. Current direction policy is {summary['direction_policy']['direction_policy_version']}; no legacy thresholds were assumed.", '',
