...
EXPECTED_CYCLE_ID = '20260924T040734.527994Z-pid69476'
...
md = [
    ...
    'Full evidence: [provider-completion.json](C:/dev/ducketz/artifacts/analysis/overnight-20260924/provider-completion.json).', '',
]
if issues:
