"""Offline audit of the September 23 source / September 24 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260924T040733.615371Z")
parser.add_argument("--expected-source-date", default="2026-09-23")
parser.add_argument("--expected-action-date", default="2026-09-24")
parser.add_argument("--expected-deadline", default="2026-09-24T11:00:00Z")
