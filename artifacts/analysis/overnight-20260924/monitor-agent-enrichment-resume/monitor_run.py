...
run = Path('C:/DATASTORE/ml/overnight-runs/20260924T064422.315446Z')
...
opra_text = (run / "loop_a_close_fetch.log").read_text(encoding="utf-8", errors="replace") if (run / "loop_a_close_fetch.log").exists() else ""
