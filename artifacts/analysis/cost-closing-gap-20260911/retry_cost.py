...
from ml.stock_target_history import _live_subscription_preflight
from ml.artifacts import file_checksum

out=Path(__file__).resolve().parent
request={'dataset':'XNAS.ITCH','schema':'ohlcv-1m','symbols':['COST'],'stype_in':'raw_symbol','start':'2026-09-10T23:30:00+00:00','end':'2026-09-11T00:00:00+00:00'}
def save(name,obj):
...
try:
 ...
 assert str(metadata.dataset)=='XNAS.ITCH' and str(metadata.schema)=='ohlcv-1m'
...
try:
 ...
 _live_subscription_preflight(client,preflight,out)
