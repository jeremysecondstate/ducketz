"""Bounded read-only audit of the September 22 overnight provider stage.
...
RUN = ROOT / 'ml/overnight-runs/20260922T040810.607319Z'
OPRA = ROOT / 'market-data/databento/opra/OPRA.PILLAR'
SOURCE, END, ACTION = '2026-09-21', '2026-09-22', '2026-09-22'
