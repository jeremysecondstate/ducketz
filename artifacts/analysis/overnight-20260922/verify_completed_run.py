"""Offline audit of the September 21 source / September 22 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260922T040810.607319Z")
parser.add_argument("--expected-source-date", default="2026-09-21")
parser.add_argument("--expected-action-date", default="2026-09-22")
parser.add_argument("--expected-deadline", default="2026-09-22T11:00:00Z")
