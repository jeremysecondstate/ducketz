"""Offline audit of the September 15 source / September 16 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260916T040757.217937Z")
parser.add_argument("--expected-source-date", default="2026-09-15")
parser.add_argument("--expected-action-date", default="2026-09-16")
parser.add_argument("--expected-deadline", default="2026-09-16T11:00:00Z")
