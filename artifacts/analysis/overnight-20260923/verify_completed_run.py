"""Offline audit of the September 22 source / September 23 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260923T040814.422433Z")
parser.add_argument("--expected-source-date", default="2026-09-22")
parser.add_argument("--expected-action-date", default="2026-09-23")
parser.add_argument("--expected-deadline", default="2026-09-23T11:00:00Z")
