"""Bounded read-only audit of the September 23 overnight provider stage.
...
EXPECTED_CYCLE_ID = '20260923T040815.264882Z-pid33836'
OPRA = ROOT / 'market-data/databento/opra/OPRA.PILLAR'
SOURCE, END, ACTION = '2026-09-22', '2026-09-23', '2026-09-23'
...
md = [
    ...
    'Full evidence: [provider-completion.json](C:/dev/ducketz/artifacts/analysis/overnight-20260923/provider-completion.json).', '',
]
if issues:
