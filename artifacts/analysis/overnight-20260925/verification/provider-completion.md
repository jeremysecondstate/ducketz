# 2026-09-25 provider evidence audit

Observed **2026-09-25T06:42:03.601248+00:00**. Status: **PASS_NATIVE_LOOP_A_AND_33_OPRA_SCOPES_COMPLETE**.

Native run `C:/DATASTORE/ml/overnight-runs/20260925T040822.112032Z` prepares **2026-09-25** from source session **2026-09-24**, with original deadline `2026-09-25T11:00:00+00:00`. Its saved/current universe agrees on 11 symbols: AAPL, AMZN, GOOG, MU, NVDA, SNDK, COST, CROX, PATH, TWST, IONQ.

Base cycle `20260925T040822.974281Z-pid22132` is **COMPLETE**, with all five configured providers. Current log has 11/11 symbol summaries, 11/11 fundamental completions, 11/11 technical completions and 11/11 signal completions. 456 logged stock Parquet paths were checked; 0 are missing.

Provider changes total **410 Parquets**. Calculations produced **44 fundamental** and **379 technical outputs**, with **0 failures** and **0 technical not-ready skips**. Every observed symbol capture summary has zero blocking and optional capture failures.

Production OPRA: **33/33** fresh exact symbol/schema preflights, **33/33** current-run exclusive `2026-09-25` cursors, **33/33** source-session Historical partition receipts, and **33/33** native COMPLETE scope log entries. Available receipts are checked for exact source/range, checksum binding, zero-dollar nested/total cost and native capacity formula. Observed estimated download size: **4,789,680,808 bytes** (20,000,000,000-byte ceiling). Current partition raw/normalized files hashed: **66**.
...
|---|---|---:|---|
| CME_CONTEXT | ohlcv-1m | 2,372 | None |
| CME_CONTEXT | bbo-1m | 300 | None |
| CME_CONTEXT | mbp-10 | 5,000 | None |
| CME_CONTRACTS | ohlcv-1m | 4,078 | None |
| CME_CONTRACTS | bbo-1m | 240 | None |
| CME_CONTRACTS | mbp-10 | 5,000 | None |
