"""Offline audit of the September 24 source / September 25 action overnight run.
...
parser.add_argument("--expected-original-run", default="20260925T040822.112032Z")
parser.add_argument("--expected-source-date", default="2026-09-24")
parser.add_argument("--expected-action-date", default="2026-09-25")
parser.add_argument("--expected-deadline", default="2026-09-25T11:00:00Z")
