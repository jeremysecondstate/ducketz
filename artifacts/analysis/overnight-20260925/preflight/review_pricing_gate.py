...
PRIOR=Path('C:/dev/ducketz/artifacts/analysis/overnight-20260924/resumed-provider/pricing-gate-review.json')
...
def main():
    ...
    check(base['generation']=='20260925T040822.974281Z-pid22132' and base['status']=='COMPLETE','Current source cycle differs')
    ...
    if manifestpath.is_file() and publicationpath.is_file():
        ...
        check(gate['model_admission_by_horizon']==prior['current_native_gate']['model_admission_by_horizon'],'Current saved feature-model admission differs')
    ...
    characteristics=prior['source_characteristics_from_unchanged_verified_prior_evidence']
