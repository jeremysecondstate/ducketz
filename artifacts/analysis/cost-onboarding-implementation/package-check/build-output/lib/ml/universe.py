...
# This is the shared configured Loops universe. Stock and option consumers
# use distinct execution contracts even though they share these symbols.
PRODUCTION_LOOPS_SYMBOLS: tuple[str, ...] = read_symbols()
...
INITIAL_RESEARCH_INSTRUMENTS: tuple[ResearchInstrument, ...] = (
    ...
    ResearchInstrument("COST", "NASDAQ", "USD", "XNAS"),
