...
from datafetching.databento_opra_history import (
    canonical_root,
    historical_full_day_supersedes_replay,
    ...
    *,
    ...
    for receipt_path in sorted(
        ...
        try:
            ...
            continue
        # A cheap inventory must not silently pick replay after a matching
        # Historical day arrives, or trust corrupt Historical replacement data.
        if historical_full_day_supersedes_replay(
            directory, datastore_root=root, manifest=manifest
        ):
            continue
