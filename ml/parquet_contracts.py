...
STRATEGY_CANDIDATE_SCHEMA = _schema(
    (
        ...
        ("pricing_conservative_edge", FLOAT),
        ("pricing_edge_to_friction", FLOAT),
        ("pricing_uncertainty", FLOAT),
        ("pricing_probability_favorable", FLOAT),
        ("pricing_relative_edge", FLOAT),
        ("pricing_model_age_seconds", FLOAT),
        ("pricing_residual_shrinkage", FLOAT),
        ("pricing_source", TEXT),
        ("model_version", TEXT),
        ("model_status", TEXT),
...
OPTION_PRICING_BSGP_SHADOW_SCHEMA = _schema(
    (
        ...
        ("bsgp_shadow_dollar_residual", FLOAT),
...
V2_OPTION_PRICING_SURFACE_SCHEMA = _schema(
    (
        ...
        ("first_available_at", UTC_TIMESTAMP),
        ("call_put", TEXT),
